...
0000000140001450 <main>:
   ...
   140001464:	c7 45 f8 04 00 00 00 	movl   $0x4,-0x8(%rbp)
   14000146b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%rbp)
   140001472:	8b 55 fc             	mov    -0x4(%rbp),%edx
   140001475:	8b 45 f8             	mov    -0x8(%rbp),%eax
   140001478:	01 d0                	add    %edx,%eax
   14000147a:	89 45 f4             	mov    %eax,-0xc(%rbp)
   14000147d:	48 8d 05 7c 2b 00 00 	lea    0x2b7c(%rip),%rax        # 140004000 <.rdata>
   140001484:	48 89 c2             	mov    %rax,%rdx
   140001487:	48 8b 05 f2 2e 00 00 	mov    0x2ef2(%rip),%rax        # 140004380 <__fu0__ZSt4cout>
   14000148e:	48 89 c1             	mov    %rax,%rcx
   140001491:	e8 2a 00 00 00       	call   1400014c0 <_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc>
   140001496:	48 89 c1             	mov    %rax,%rcx
   140001499:	8b 45 f4             	mov    -0xc(%rbp),%eax
   14000149c:	89 c2                	mov    %eax,%edx
   14000149e:	e8 2d 00 00 00       	call   1400014d0 <_ZNSolsEi>
   1400014a3:	48 89 c1             	mov    %rax,%rcx
   1400014a6:	48 8b 05 e3 2e 00 00 	mov    0x2ee3(%rip),%rax        # 140004390 <.refptr._ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_>
   1400014ad:	48 89 c2             	mov    %rax,%rdx
   1400014b0:	e8 23 00 00 00       	call   1400014d8 <_ZNSolsEPFRSoS_E>
   1400014b5:	b8 00 00 00 00       	mov    $0x0,%eax
   1400014ba:	48 83 c4 30          	add    $0x30,%rsp
   1400014be:	5d                   	pop    %rbp
   1400014bf:	c3                   	ret
